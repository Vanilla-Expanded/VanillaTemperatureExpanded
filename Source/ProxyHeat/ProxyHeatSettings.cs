...
namespace ProxyHeat
{
    ...
    class ProxyHeatSettings : ModSettings
    {
        ...
        public bool enableProxyHeat = true;
        ...
        {
            base.ExposeData();
            Scribe_Values.Look(ref enableProxyHeat, "enableProxyHeat", true);
        ...
        public void DoSettingsWindowContents(Rect inRect)
        {
            ...
            ls.Begin(inRect);
            var initY = ls.curY;
            ls.CheckboxLabeled("PH.EnableProxyHeat".Translate(), ref enableProxyHeat);
            if (enableProxyHeat)
            {
